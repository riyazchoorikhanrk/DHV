# -*- coding: utf-8 -*-
"""Original_Riyaz_dhv_Assignment

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1kaXRGbh-PAgbk-gbuNwC_Q-KnSfMwgyO
"""
...
df1 = pd.read_csv("/content/drive/MyDrive/dataset/Riyaz_project/archive/gdp.csv") #gdp
df2 = pd.read_csv("/content/drive/MyDrive/dataset/Riyaz_project/archive/gdp_growth.csv") #gdp_growth
...
"Latin America & Caribbean (excluding high income)" ,
  ...
  "Early-demographic dividend" , "South Asia ", "South Asia (IDA & IBRD)"
...
,"Aruba", "Andorra" , "	Channel Islands	","Eritrea",
   "Faroe Islands" , "Gibraltar" , "Greenland", "Isle of Man",
"Not classified	","Liechtenstein" ,
   "Channel Islands","Sint Maarten (Dutch part)	" ,"South Sudan	"
    ,"San Marino","French Polynesia	","Korea, Dem. People's Rep.",
...
def plot_gdp_comparison(df):
    ...
    top_countries_latest_year = df[['Country_Name', latest_year]].nlargest(10, latest_year)
    bottom_countries_latest_year = df[['Country_Name', latest_year]].nsmallest(10, latest_year)

    top_countries_latest_year[latest_year] = pd.to_numeric(top_countries_latest_year[latest_year])
    bottom_countries_latest_year[latest_year] = pd.to_numeric(bottom_countries_latest_year[latest_year])
...
def plot_gdp_growth(df):
    ...
    global_gdp_growth_10_years = global_gdp_growth_top_countries.resample('10A').mean()
    ...
    for country in global_gdp_growth_10_years.columns:
        sns.lineplot(x=global_gdp_growth_10_years.index, y=global_gdp_growth_10_years[country], label=country)

    plt.legend(title='Country', loc='upper left', bbox_to_anchor=(1, 1))

    plt.title('Performance of Top 10  Countries GDP Growth Over 10-Year Intervals from (1960-2020)')
...
def plot_gdp_growth_comparison(df):
    ...
    countries_of_interest = ["United States", "China", "Japan", "Germany", "United Kingdom"]
